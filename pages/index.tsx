...
export default function Home() {
  ...
  const config = {
    headers: { Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imhhc2FuY2FrbWFrMTFAZ21haWwuY29tIiwiaWF0IjoxNjcxOTY1NzY5LCJleHAiOjE2OTc4ODU3Njl9.uf2uHYHyCJT9VN9XgRNdzdpyQv4hw3DEV0m_PK945Ws` }
  };
...
function User({session}){
  return(
    <div>
      ...
      <div className=' grid grid-flow-row gap-8 mt-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 '>
          
          <div className="max-w-sm  bg-gray-100 border border-gray-300 rounded-3xl shadow-md dark:bg-gray-800 dark:border-gray-700">
              <a href="/detail" className=''>
                  <AiFillHeart className='text-2xl text-gray-300 hover:text-red-500 duration-300' />
                  <img className="w-auto p-10" src="https://www.informit.com/ShowCover.aspx?isbn=0134671791" alt="" />
              </a>
              <div className="p-5">
                  
                  <p className="mb-3 font-bold text-sm text-center text-gray-800 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
                  <div className='flex items-center my-4 before:flex-1 before:border-t before:border-gray-400 before:mt-0.5 after:flex-1 after:border-t after:border-gray-400 after:mt-0.5'>
                     <span className='text-center font-light mx-4 mb-0 text-gray-500'>-</span>
                  </div>
                  <a href="#" className="w-full justify-center inline-flex  items-center px-3 py-2  text-center text-blue-600 font-bold text-lg">
                      35.00 ₺
                  </a>
              </div>
          </div>
